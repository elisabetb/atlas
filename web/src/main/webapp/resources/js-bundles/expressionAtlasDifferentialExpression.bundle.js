...
function(e,t,r){"use strict";e.exports=r(/*! ./src/differentialRenderer.js */1874)},1874:/*!******************************************************************************!*\
  ...
  \******************************************************************************/
function(e,t,r){"use strict";var s=r(/*! react */1875),n=r(/*! react-dom */2031),i=r(/*! ./DifferentialRouter.jsx */2032);e.exports=function(e){var t=e.atlasHostUrl,r=void 0===t?window.location.protocol+"//"+window.location.host:t,o=e.geneQuery,a=e.conditionQuery,l=e.species,p=e.target,c=void 0===p?"gxaDifferentialTab":p;n.render(s.createElement(i,{hostUrl:r,geneQuery:o,conditionQuery:a,species:l}),document.getElementById(c))}},1875:/*!*******************************************************************!*\
...
[2819,1877],2032:/*!*****************************************************************************!*\
  ...
  \*****************************************************************************/
function(e,t,r){"use strict";var s=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var s in r)Object.prototype.hasOwnProperty.call(r,s)&&(e[s]=r[s])}return e},n=r(/*! react */1875),i=r(/*! jquery */2033);i.ajaxSetup({traditional:!0});var o=r(/*! url */2034),a=r(/*! ./DifferentialResults.jsx */2039),l=r(/*! ./DifferentialFacetsTree.jsx */2155),p=r(/*! ./urlManager.js */2158),c=n.PropTypes.string.isRequired,u=n.createClass({displayName:"DifferentialRouter",propTypes:{hostUrl:c,geneQuery:c,conditionQuery:c,species:c},getInitialState:function(){return{facetsTreeData:[],results:[],legend:{maxDownLevel:0,minDownLevel:0,minUpLevel:0,maxUpLevel:0},querySelect:{}}},componentDidMount:function(){var e=this;this._loadInitialData(),window.addEventListener("popstate",function(){e.setState({querySelect:p.parseDifferentialUrlParameter()})},!1)},_addElementToObjectOfArrays:function(e,t,r){e[t]||(e[t]=[]),e[t].push(r)},_removeElementFromObjectOfArrays:function(e,t,r){delete e[t].splice(e[t].indexOf(r),1),0===e[t].length&&delete e[t]},_setChecked:function(e,t,r){var s=JSON.parse(JSON.stringify(this.state.querySelect));r?this._addElementToObjectOfArrays(s,e,t):this._removeElementFromObjectOfArrays(s,e,t),p.differentialPush(s,!1),this.setState({querySelect:s})},_filteredResults:function(){var e=this,t=arguments.length<=0||void 0===arguments[0]?this.state.querySelect:arguments[0];return this.state.results.filter(function(r){return e._resultMatchesQuery(r,t)})},_resultMatchesQuery:function(e,t){var r=this;return 0!==Object.keys(t).length&&Object.keys(t).every(function(s){return t[s].some(function(t){return r._equalsToOrIncludes(e[s],t)})})},_equalsToOrIncludes:function(e,t){return!!e&&(e.constructor===Array?e.indexOf(t)>-1:e===t)},_prepareFacetTreeData:function(e){var t=this;return this.state.facetsTreeData.map(function(r){return{facetName:r.facetName,facetItems:r.facetItems.map(function(s){var n=e.every(function(e){return t._equalsToOrIncludes(e[r.facetName],s.name)}),i=JSON.parse(JSON.stringify(t.state.querySelect));t._equalsToOrIncludes(i[r.facetName],s.name)?t._removeElementFromObjectOfArrays(i,r.facetName,s.name):t._addElementToObjectOfArrays(i,r.facetName,s.name);var o=t._filteredResults(i).map(function(e){return e.id}).sort(),a=e.map(function(e){return e.id}).sort(),l=JSON.stringify(o)===JSON.stringify(a),p=0===o.length;return{name:s.name,value:s.value,checked:t._equalsToOrIncludes(t.state.querySelect[r.facetName],s.name)||l&&n,disabled:p||l}})}})},render:function(){var e=this._filteredResults();return n.createElement("div",null,n.createElement("div",{className:"grid_6 alpha",id:"gxaDifferentialFacetsContainerDiv"},Object.keys(this.state.facetsTreeData).length?n.createElement(l,{facets:this._prepareFacetTreeData(e),setChecked:this._setChecked}):n.createElement("div",null)),n.createElement("div",{className:"grid_18 omega",id:"gxaDifferentialResultsContainerDiv"},this.state.results&&this.state.results.length?n.createElement(a,s({results:e,hostUrl:this.props.hostUrl},this.state.legend)):n.createElement("div",{ref:"loadingImagePlaceholder"},n.createElement("img",{src:this.props.hostUrl+"/gxa/resources/images/loading.gif"}))))},_loadInitialData:function(){var e=this,t=o.parse(this.props.hostUrl),r=o.parse(this.props.hostUrl);t.pathname="gxa/json/query/differentialFacets",r.pathname="gxa/json/query/differentialResults";var s={geneQuery:this.props.geneQuery,conditionQuery:this.props.conditionQuery,organism:this.props.species};t.query=s,r.query=s;var n=function(e,t,r){console.log("ERROR"),console.log("Status: "+t),console.log("Error thrown: "+r)};i.ajax({url:o.format(t),dataType:"json",success:function(t){i.ajax({url:o.format(r),dataType:"json",success:function(r){var s=p.parseDifferentialUrlParameter();s.kingdom||(s.kingdom=t.kingdom.map(function(e){return e.name})),p.differentialPush(s,!0);var n=e._transformFacetsResponseToArray(t);e.setState({facetsTreeData:e._pruneFacetsTreeBasedOnResultsThatCameIn(n,r.results),querySelect:s,results:r.results,legend:{minDownLevel:r.minDownLevel,minUpLevel:r.minUpLevel,maxDownLevel:r.maxDownLevel,maxUpLevel:r.maxUpLevel}})},error:n})},error:n})},_transformFacetsResponseToArray:function(e){return Object.keys(e).map(function(t){return{facetName:t,facetItems:e[t].map(function(e){return{name:e.name,value:e.value,disabled:!1,checked:!1}})}})},_pruneFacetsTreeBasedOnResultsThatCameIn:function(e,t){return e.map(function(e){return{facetName:e.facetName,facetItems:e.facetItems.filter(function(r){return t.some(function(t){return t[e.facetName].constructor===Array?t[e.facetName].indexOf(r.name)>-1:t[e.facetName]===r.name})})}}).filter(function(e){return e.facetItems.length>0})}});e.exports=u},2033:/*!**************************************************************************!*\
  !*** ./expression-atlas-differential-expression/~/jquery/dist/jquery.js ***!
  \**************************************************************************/
624,2034:/*!***************************************************************!*\
  !*** ./expression-atlas-differential-expression/~/url/url.js ***!
  \***************************************************************/
function(e,t,r){function s(){this.protocol=null,this.slashes=null,this.auth=null,this.host=null,this.port=null,this.hostname=null,this.hash=null,this.search=null,this.query=null,this.pathname=null,this.path=null,this.href=null}function n(e,t,r){if(e&&p(e)&&e instanceof s)return e;var n=new s;return n.parse(e,t,r),n}function i(e){return l(e)&&(e=n(e)),e instanceof s?e.format():s.prototype.format.call(e)}function o(e,t){return n(e,!1,!0).resolve(t)}function a(e,t){return e?n(e,!1,!0).resolveObject(t):t}function l(e){return"string"==typeof e}function p(e){return"object"==typeof e&&null!==e}function c(e){return null===e}function u(e){return null==e}var h=r(/*! punycode */2035);t.parse=n,t.resolve=o,t.resolveObject=a,t.format=i,t.Url=s;var d=/^([a-z0-9.+-]+:)/i,f=/:[0-9]*$/,m=["<",">",'"',"`"," ","\r","\n","\t"],g=["{","}","|","\\","^","`"].concat(m),y=["'"].concat(g),x=["%","/","?",";","#"].concat(y),v=["/","?","#"],b=255,w=/^[a-z0-9A-Z_-]{0,63}$/,T=/^([a-z0-9A-Z_-]{0,63})(.*)$/,C={javascript:!0,"javascript:":!0},E={javascript:!0,"javascript:":!0},k={http:!0,https:!0,ftp:!0,gopher:!0,file:!0,"http:":!0,"https:":!0,"ftp:":!0,"gopher:":!0,"file:":!0},R=r(/*! querystring */2036);s.prototype.parse=function(e,t,r){if(!l(e))throw new TypeError("Parameter 'url' must be a string, not "+typeof e);var s=e;s=s.trim();var n=d.exec(s);if(n){n=n[0];var i=n.toLowerCase();this.protocol=i,s=s.substr(n.length)}if(r||n||s.match(/^\/\/[^@\/]+@[^@\/]+/)){var o="//"===s.substr(0,2);!o||n&&E[n]||(s=s.substr(2),this.slashes=!0)}if(!E[n]&&(o||n&&!k[n])){for(var a=-1,p=0;p<v.length;p++){var c=s.indexOf(v[p]);c!==-1&&(a===-1||c<a)&&(a=c)}var u,f;f=a===-1?s.lastIndexOf("@"):s.lastIndexOf("@",a),f!==-1&&(u=s.slice(0,f),s=s.slice(f+1),this.auth=decodeURIComponent(u)),a=-1;for(var p=0;p<x.length;p++){var c=s.indexOf(x[p]);c!==-1&&(a===-1||c<a)&&(a=c)}a===-1&&(a=s.length),this.host=s.slice(0,a),s=s.slice(a),this.parseHost(),this.hostname=this.hostname||"";var m="["===this.hostname[0]&&"]"===this.hostname[this.hostname.length-1];if(!m)for(var g=this.hostname.split(/\./),p=0,S=g.length;p<S;p++){var N=g[p];if(N&&!N.match(w)){for(var P="",D=0,_=N.length;D<_;D++)P+=N.charCodeAt(D)>127?"x":N[D];if(!P.match(w)){var L=g.slice(0,p),q=g.slice(p+1),O=N.match(T);O&&(L.push(O[1]),q.unshift(O[2])),q.length&&(s="/"+q.join(".")+s),this.hostname=L.join(".");break}}}if(this.hostname.length>b?this.hostname="":this.hostname=this.hostname.toLowerCase(),!m){for(var I=this.hostname.split("."),F=[],p=0;p<I.length;++p){var A=I[p];F.push(A.match(/[^A-Za-z0-9_-]/)?"xn--"+h.encode(A):A)}this.hostname=F.join(".")}var U=this.port?":"+this.port:"",j=this.hostname||"";this.host=j+U,this.href+=this.host,m&&(this.hostname=this.hostname.substr(1,this.hostname.length-2),"/"!==s[0]&&(s="/"+s))}if(!C[i])for(var p=0,S=y.length;p<S;p++){var B=y[p],V=encodeURIComponent(B);V===B&&(V=escape(B)),s=s.split(B).join(V)}var M=s.indexOf("#");M!==-1&&(this.hash=s.substr(M),s=s.slice(0,M));var H=s.indexOf("?");if(H!==-1?(this.search=s.substr(H),this.query=s.substr(H+1),t&&(this.query=R.parse(this.query)),s=s.slice(0,H)):t&&(this.search="",this.query={}),s&&(this.pathname=s),k[i]&&this.hostname&&!this.pathname&&(this.pathname="/"),this.pathname||this.search){var U=this.pathname||"",A=this.search||"";this.path=U+A}return this.href=this.format(),this},s.prototype.format=function(){var e=this.auth||"";e&&(e=encodeURIComponent(e),e=e.replace(/%3A/i,":"),e+="@");var t=this.protocol||"",r=this.pathname||"",s=this.hash||"",n=!1,i="";this.host?n=e+this.host:this.hostname&&(n=e+(this.hostname.indexOf(":")===-1?this.hostname:"["+this.hostname+"]"),this.port&&(n+=":"+this.port)),this.query&&p(this.query)&&Object.keys(this.query).length&&(i=R.stringify(this.query));var o=this.search||i&&"?"+i||"";return t&&":"!==t.substr(-1)&&(t+=":"),this.slashes||(!t||k[t])&&n!==!1?(n="//"+(n||""),r&&"/"!==r.charAt(0)&&(r="/"+r)):n||(n=""),s&&"#"!==s.charAt(0)&&(s="#"+s),o&&"?"!==o.charAt(0)&&(o="?"+o),r=r.replace(/[?#]/g,function(e){return encodeURIComponent(e)}),o=o.replace("#","%23"),t+n+r+o+s},s.prototype.resolve=function(e){return this.resolveObject(n(e,!1,!0)).format()},s.prototype.resolveObject=function(e){if(l(e)){var t=new s;t.parse(e,!1,!0),e=t}var r=new s;if(Object.keys(this).forEach(function(e){r[e]=this[e]},this),r.hash=e.hash,""===e.href)return r.href=r.format(),r;if(e.slashes&&!e.protocol)return Object.keys(e).forEach(function(t){"protocol"!==t&&(r[t]=e[t])}),k[r.protocol]&&r.hostname&&!r.pathname&&(r.path=r.pathname="/"),r.href=r.format(),r;if(e.protocol&&e.protocol!==r.protocol){if(!k[e.protocol])return Object.keys(e).forEach(function(t){r[t]=e[t]}),r.href=r.format(),r;if(r.protocol=e.protocol,e.host||E[e.protocol])r.pathname=e.pathname;else{for(var n=(e.pathname||"").split("/");n.length&&!(e.host=n.shift()););e.host||(e.host=""),e.hostname||(e.hostname=""),""!==n[0]&&n.unshift(""),n.length<2&&n.unshift(""),r.pathname=n.join("/")}if(r.search=e.search,r.query=e.query,r.host=e.host||"",r.auth=e.auth,r.hostname=e.hostname||e.host,r.port=e.port,r.pathname||r.search){var i=r.pathname||"",o=r.search||"";r.path=i+o}return r.slashes=r.slashes||e.slashes,r.href=r.format(),r}var a=r.pathname&&"/"===r.pathname.charAt(0),p=e.host||e.pathname&&"/"===e.pathname.charAt(0),h=p||a||r.host&&e.pathname,d=h,f=r.pathname&&r.pathname.split("/")||[],n=e.pathname&&e.pathname.split("/")||[],m=r.protocol&&!k[r.protocol];if(m&&(r.hostname="",r.port=null,r.host&&(""===f[0]?f[0]=r.host:f.unshift(r.host)),r.host="",e.protocol&&(e.hostname=null,e.port=null,e.host&&(""===n[0]?n[0]=e.host:n.unshift(e.host)),e.host=null),h=h&&(""===n[0]||""===f[0])),p)r.host=e.host||""===e.host?e.host:r.host,r.hostname=e.hostname||""===e.hostname?e.hostname:r.hostname,r.search=e.search,r.query=e.query,f=n;else if(n.length)f||(f=[]),f.pop(),f=f.concat(n),r.search=e.search,r.query=e.query;else if(!u(e.search)){if(m){r.hostname=r.host=f.shift();var g=!!(r.host&&r.host.indexOf("@")>0)&&r.host.split("@");g&&(r.auth=g.shift(),r.host=r.hostname=g.shift())}return r.search=e.search,r.query=e.query,c(r.pathname)&&c(r.search)||(r.path=(r.pathname?r.pathname:"")+(r.search?r.search:"")),r.href=r.format(),r}if(!f.length)return r.pathname=null,r.search?r.path="/"+r.search:r.path=null,r.href=r.format(),r;for(var y=f.slice(-1)[0],x=(r.host||e.host)&&("."===y||".."===y)||""===y,v=0,b=f.length;b>=0;b--)y=f[b],"."==y?f.splice(b,1):".."===y?(f.splice(b,1),v++):v&&(f.splice(b,1),v--);if(!h&&!d)for(;v--;v)f.unshift("..");!h||""===f[0]||f[0]&&"/"===f[0].charAt(0)||f.unshift(""),x&&"/"!==f.join("/").substr(-1)&&f.push("");var w=""===f[0]||f[0]&&"/"===f[0].charAt(0);if(m){r.hostname=r.host=w?"":f.length?f.shift():"";var g=!!(r.host&&r.host.indexOf("@")>0)&&r.host.split("@");g&&(r.auth=g.shift(),r.host=r.hostname=g.shift())}return h=h||r.host&&f.length,h&&!w&&f.unshift(""),f.length?r.pathname=f.join("/"):(r.pathname=null,r.path=null),c(r.pathname)&&c(r.search)||(r.path=(r.pathname?r.pathname:"")+(r.search?r.search:"")),r.auth=e.auth||r.auth,r.slashes=r.slashes||e.slashes,r.href=r.format(),r},s.prototype.parseHost=function(){var e=this.host,t=f.exec(e);t&&(t=t[0],":"!==t&&(this.port=t.substr(1)),e=e.substr(0,e.length-t.length)),e&&(this.hostname=e)}},2035:/*!*******************************************************************************!*\
  !*** ./expression-atlas-differential-expression/~/url/~/punycode/punycode.js ***!
  \*******************************************************************************/
function(e,t,r){var s;(function(e,n){!function(i){function o(e){throw RangeError(L[e])}function a(e,t){for(var r=e.length,s=[];r--;)s[r]=t(e[r]);return s}function l(e,t){var r=e.split("@"),s="";r.length>1&&(s=r[0]+"@",e=r[1]),e=e.replace(_,".");var n=e.split("."),i=a(n,t).join(".");return s+i}function p(e){for(var t,r,s=[],n=0,i=e.length;n<i;)t=e.charCodeAt(n++),t>=55296&&t<=56319&&n<i?(r=e.charCodeAt(n++),56320==(64512&r)?s.push(((1023&t)<<10)+(1023&r)+65536):(s.push(t),n--)):s.push(t);return s}function c(e){return a(e,function(e){var t="";return e>65535&&(e-=65536,t+=I(e>>>10&1023|55296),e=56320|1023&e),t+=I(e)}).join("")}function u(e){return e-48<10?e-22:e-65<26?e-65:e-97<26?e-97:w}function h(e,t){return e+22+75*(e<26)-((0!=t)<<5)}function d(e,t,r){var s=0;for(e=r?O(e/k):e>>1,e+=O(e/t);e>q*C>>1;s+=w)e=O(e/q);return O(s+(q+1)*e/(e+E))}function f(e){var t,r,s,n,i,a,l,p,h,f,m=[],g=e.length,y=0,x=S,v=R;for(r=e.lastIndexOf(N),r<0&&(r=0),s=0;s<r;++s)e.charCodeAt(s)>=128&&o("not-basic"),m.push(e.charCodeAt(s));for(n=r>0?r+1:0;n<g;){for(i=y,a=1,l=w;n>=g&&o("invalid-input"),p=u(e.charCodeAt(n++)),(p>=w||p>O((b-y)/a))&&o("overflow"),y+=p*a,h=l<=v?T:l>=v+C?C:l-v,!(p<h);l+=w)f=w-h,a>O(b/f)&&o("overflow"),a*=f;t=m.length+1,v=d(y-i,t,0==i),O(y/t)>b-x&&o("overflow"),x+=O(y/t),y%=t,m.splice(y++,0,x)}return c(m)}function m(e){var t,r,s,n,i,a,l,c,u,f,m,g,y,x,v,E=[];for(e=p(e),g=e.length,t=S,r=0,i=R,a=0;a<g;++a)m=e[a],m<128&&E.push(I(m));for(s=n=E.length,n&&E.push(N);s<g;){for(l=b,a=0;a<g;++a)m=e[a],m>=t&&m<l&&(l=m);for(y=s+1,l-t>O((b-r)/y)&&o("overflow"),r+=(l-t)*y,t=l,a=0;a<g;++a)if(m=e[a],m<t&&++r>b&&o("overflow"),m==t){for(c=r,u=w;f=u<=i?T:u>=i+C?C:u-i,!(c<f);u+=w)v=c-f,x=w-f,E.push(I(h(f+v%x,0))),c=O(v/x);E.push(I(h(c,0))),i=d(r,y,s==n),r=0,++s}++r,++t}return E.join("")}function g(e){return l(e,function(e){return P.test(e)?f(e.slice(4).toLowerCase()):e})}function y(e){return l(e,function(e){return D.test(e)?"xn--"+m(e):e})}var x=("object"==typeof t&&t&&!t.nodeType&&t,"object"==typeof e&&e&&!e.nodeType&&e,"object"==typeof n&&n);x.global!==x&&x.window!==x&&x.self!==x||(i=x);var v,b=2147483647,w=36,T=1,C=26,E=38,k=700,R=72,S=128,N="-",P=/^xn--/,D=/[^\x20-\x7E]/,_=/[\x2E\u3002\uFF0E\uFF61]/g,L={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},q=w-T,O=Math.floor,I=String.fromCharCode;v={version:"1.3.2",ucs2:{decode:p,encode:c},decode:f,encode:m,toASCII:y,toUnicode:g},s=function(){return v}.call(t,r,t,e),!(void 0!==s&&(e.exports=s))}(this)}).call(t,r(/*! ./../../../../../~/webpack/buildin/module.js */632)(e),function(){return this}())},2036:/*!*************************************************************************!*\
...
function(e,t,r){"use strict";t.decode=t.parse=r(/*! ./decode */2037),t.encode=t.stringify=r(/*! ./encode */2038)},2037:/*!**************************************************************************!*\
  ...
  \**************************************************************************/
function(e,t){"use strict";function r(e,t){return Object.prototype.hasOwnProperty.call(e,t)}e.exports=function(e,t,s,n){t=t||"&",s=s||"=";var i={};if("string"!=typeof e||0===e.length)return i;var o=/\+/g;e=e.split(t);var a=1e3;n&&"number"==typeof n.maxKeys&&(a=n.maxKeys);var l=e.length;a>0&&l>a&&(l=a);for(var p=0;p<l;++p){var c,u,h,d,f=e[p].replace(o,"%20"),m=f.indexOf(s);m>=0?(c=f.substr(0,m),u=f.substr(m+1)):(c=f,u=""),h=decodeURIComponent(c),d=decodeURIComponent(u),r(i,h)?Array.isArray(i[h])?i[h].push(d):i[h]=[i[h],d]:i[h]=d}return i}},2038:/*!**************************************************************************!*\
